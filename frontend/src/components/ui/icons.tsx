...
export function IconStarFilled({ className, ...rest }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function IconSun({ className, ...rest }: IconProps) {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M10 2a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 2zm0 13a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 15zm-7.25-5a.75.75 0 000 1.5h1.5a.75.75 0 000-1.5h-1.5zm12.5.75a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5h-1.5a.75.75 0 01-.75-.75zM5.22 4.16a.75.75 0 011.06 0l1.062 1.06a.75.75 0 11-1.061 1.062L5.22 5.22a.75.75 0 010-1.06zm9.5 9.5a.75.75 0 011.06 0l1.062 1.061a.75.75 0 01-1.061 1.062l-1.062-1.062a.75.75 0 010-1.06zM4.16 14.78a.75.75 0 010-1.061l1.06-1.062a.75.75 0 111.062 1.061l-1.061 1.062a.75.75 0 01-1.061 0zm9.5-9.5a.75.75 0 010-1.061l1.061-1.062a.75.75 0 111.062 1.061l-1.062 1.062a.75.75 0 01-1.06 0zM10 6.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" />
    </svg>
  )
}
...
export function IconExternalLink({ className, ...rest }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
